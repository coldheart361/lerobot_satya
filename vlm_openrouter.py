...
class VLM:
    def __init__(self, model="anthropic/claude-opus-4.8", api_key=None):
        # gpt-4o-mini is ~15x cheaper than gpt-4o, good enough for keypoint reasoning
        self.model = model
    ...
    def query(self, prompt: str, image: np.ndarray = None, max_tokens: int = 2000) -> str:
